import image1 from "../assets/Images/16 pro max.webp";
import image2 from "../assets/Images/new.jpg";
import image3 from "../assets/Images/vivox-22.webp";
import image4 from "../assets/Images/in-galaxy-zflip7.png";

import image5 from "../assets/Images/s25.webp";
import image6 from "../assets/Images/i16.webp";
...
// ⭐ Add Random Stock (5 to 100) and Random Rating (3.0 to 5.0)
export const enhancedMockData = mockData.map(item => ({
    ...item,
    stock: Math.floor(Math.random() * 96) + 5,           // 5–100
